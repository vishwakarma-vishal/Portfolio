...
export default function Social() {
    return (
        <div className="home__social">
            <a href="https://www.linkedin.com/in/vishwakarma-vishal2001/" className="home__social-icon" target="_blank">
            ...
            <a href="https://x.com/vishaldev29" className="home__social-icon" target="_blank">
